                    ...
                    <div class="col-12">
                        <p class="samuraimart-product-label mt-2">
                            ...
                            @if ($recommend_product->reviews()->exists())
                                <span class="samuraimart-star-rating" data-rate="{{ $recommend_product->averageScore() }}"></span>
                                {{ $recommend_product->averageScore() }}<br>
                            @endif
                        ...
                        <div class="col-12">
                            <p class="samuraimart-product-label mt-2">
                                ...
                                @if ($recently_product->reviews()->exists())
                                    <span class="samuraimart-star-rating" data-rate="{{ $recently_product->averageScore() }}"></span>
                                    {{ $recently_product->averageScore() }}<br>
                                @endif
